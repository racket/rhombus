...
@doc(  
  class_clause.macro 'constructor $fun_form',
 ...
 @rhombus(constructor, ~class_clause), the @rhombus(fun_form) shorthand
 is the same as using a @rhombus(fun) @tech{entry point}, and for
