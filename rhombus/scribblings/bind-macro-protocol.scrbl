...
@itemlist[
  ...
  @item{A compile-time function that generates code that checks the input
  ...
  @item{A compile-time function that generates definitions for the bound
    ...
    that are affected by @rhombus[forward]. The generated definitions do not
...
parsed binding's data. The result must be a single-object tuple with six
parts:
...
One subtlety here is the syntactic category of @rhombus[IF] or a builder
