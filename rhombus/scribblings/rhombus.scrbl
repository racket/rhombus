...
indentation for grouping. A line with more indentation starts a @emph{block},
and it’s always after a line that ends @litchar{:}, that ends
@litchar{|} (much less commonly), or that starts @litchar{|}. You can
think of a more-indented @litchar{|} as being preceded implicitly by a
@litchar{:} at the end of the previous line. A @litchar{|} counts as
