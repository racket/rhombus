...
is evaluated, instead. The @rhombus(guard) form is equivalent to
...
evaluated, instead. The @rhombus(guard.let) form is a pattern-matching variant of
@rhombus(guard); see @rhombus(guard) for general advice on using
guards.
