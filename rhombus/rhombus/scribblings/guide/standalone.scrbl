...
implementation that starts up more quickly. The @exec{raco demod} tool
performs that kind of pruning:

@nested(~style: #'inset){@exec{raco demod -g -o prog_small.zo prog.rhm}}
